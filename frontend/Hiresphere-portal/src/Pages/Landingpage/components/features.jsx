          ...
          <div>
            ...
            <div className='space-y-8'>
              {JobseekerFeatures.map((feature, index) => (
                ...
                >
                  <div className='shrink-0 w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 group-hover:bg-blue-200 transition-all duration-300'>
          ...
          <div>
            ...
            <div className='space-y-8'>
              {EmployerFeatures.map((feature, index) => (
                ...
                >
                  <div className='shrink-0 w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center group-hover:bg-purple-200 transition-all duration-300'>
